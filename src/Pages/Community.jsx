...
function Community() {
  return (
    <div className="relative w-full px-4 py-8 sm:py-12 mt-0 sm:mt-0 overflow-visible [clip-path:inset(0_0_20px_0)]">
      <div className="relative z-10 max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center md:justify-between">
        ...
        <div className="absolute bg-cyan-500 opacity-[0.1] blur-[480px] rounded-full  w-[190px] h-[110px] sm:w-[250px] sm:h-[180px] md:w-[300px] md:h-[240px]  left-[-90px] bottom-[-500] sm:bottom-[-130px] md:bottom-[-180px] z-0" />
  ...
  <br className="hidden [@media(min-width:1922px)]:block" />
            <span className="bg-gradient-to-r from-[#FE3B76] via-[#AF29CE] to-[#2931DD] bg-clip-text text-transparent"> Global Developer Community </span> 
          </h2>
          ...
          <form className="w-full flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
            <input type="email"  placeholder="Your Email"  className="w-[343px] h-[52px] sm:w-[361px] sm:h-[52px] xl:w-[361px] xl:h-[48px] px-4 py-2.5 sm:py-3 text-sm rounded-lg border-2 border-gray-200 focus:outline-none focus:border-blue-400" />
