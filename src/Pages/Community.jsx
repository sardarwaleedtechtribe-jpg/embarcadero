...
function Community() {
  return (
    <div className="relative w-full px-4 py-8 sm:py-12 mt-0 sm:mt-0 overflow-visible">
      {/* Centered container with relative positioning for the glow */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center md:justify-between">
        {/* Background Glow — stays fixed relative to content */}
        <div className="absolute bg-indigo-200 opacity-50 blur-[80px] rounded-full  w-[250px] h-[350px] sm:w-[300px] sm:h-[450px] md:w-[350px] md:h-[480px]  left-[-100px] top-[-200px] sm:left-[-150px] sm:top-[-250px] md:left-[-180px] md:top-[-280px]  z-0" />
        {/* Text Section */}
