...
const Product = () => {
  ...
  return (
    <div className=" relative w-full min-h-[30vh] sm:min-h-[33vh] md:min-h-[40vh] lg:min-h-[45vh]   pb-12 md:pb-14    lg:pb-22 xl:pb-27  xl:min-h-[48vh] 2xl:min-h-[48vh] flex items-start justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className=" relative  z-10 w-full flex flex-col items-center justify-center">
        <div
          className="absolute bg-rose-500 opacity-5 blur-[400px] rounded-1x1 z-0 pointer-events-none 
        ...
        <div
          className="absolute bg-cyan-600 sm:bg-blue-[500px] md:bg-cyan-600 opacity-5 blur-[100px] rounded-2xl border border-white z-0 pointer-events-none
        ...
        />
        <div
          className="absolute bg-[#3037DE]/10 blur-[500px] rounded-2xl border border-white  z-0 pointer-events-none
  ...
  "
        ...
        <div className="w-full flex flex-col items-center text-center  mt-16 xs:mt-20 sm:mt-12 md:mt-16 lg:mt-20 xl:mt-28">
          ...
          <div className=" w-full max-w-[1540px] mx-auto px-1 sm:px-2 lg:px-2 xl:px-15 2xl:px-10">
          ...
          <h2 className=" text-[36px] sm:text-[48px] md:text-[48px] lg:text-[64px]  2xl:text-[64px] font-semibold bg-gradient-to-r from-[#FE3B76] via-[#AF29CE] to-[#2931DD] bg-clip-text text-transparent px-2 xs:px-4 mt-2">
            Developer Tools
          </h2>
          <p className="text-[18px]  sm:text-xl md:text-[24px]  text-gray-600 mt-4 sm:mt-6 md:mt-8 lg:mt-8 xl:mt-8 px-2 xs:px-4 max-w-4xl">
            ...
            {logos.map((logo, idx) => (
              ...
              >
                <img
                  src={logo.img}
                  alt={`logo${idx + 1}`}
                  className="object-contain h-auto w-[40px]  md:w-[48px] "
                />
              </div>
            ))}
          </div>
