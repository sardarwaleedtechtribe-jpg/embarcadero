...
const Product = () => {
  ...
  return (
    <div className=" relative w-full min-h-[40vh] sm:min-h-[50vh] md:min-h-[40vh] lg:min-h-[45vh] xl:min-h-[87vh] 2xl:min-h-[67vh]  flex items-start justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="relative  z-10 w-full flex flex-col items-center justify-center">
        <div  className="absolute bg-cyan-600 opacity-25 blur-[250px] rounded-full z-0 pointer-events-none  w-[clamp(200px,28vw,640px)] h-[clamp(580px,22vw,480px)]  left-1/2 top-[50%]  -translate-x-[130%] sm:-translate-x-[150%] md:-translate-x-[170%] lg:-translate-x-[190%] -translate-y-[20%]" aria-hidden="true"  />
        <div  className="absolute bg-rose-600 opacity-25 blur-[300px] rounded-full z-0 pointer-events-none  w-[clamp(200px,28vw,640px)] h-[clamp(580px,22vw,480px)]  left-1/2 top-[20%]   translate-x-[50%]   sm:translate-x-[60%] md:translate-x-[70%] lg:translate-x-[80%]  -translate-y-[20%]" aria-hidden="true" />
        <div className=" w-full flex flex-col items-center text-center  mt-16 xs:mt-20 sm:mt-8 md:mt-16 lg:mt-16 xl:mt-28">
          <div className="w-full pt-4 px-4 xs:px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20">
            <nav  className="max-w-4xl mx-auto w-full text-left flex items-center text-sm text-gray-600 z-20 
              -mt-14 xs:-mt-12 sm:-mt-10 md:-mt-14 lg:-mt-16 xl:-mt-24
              -translate-x-2 sm:-translate-x-4 md:-translate-x-8 lg:-translate-x-14 xl:-translate-x-38"
            >
          ...
          <div className="w-full  flex flex-wrap justify-center items-center gap-3 xs:gap-4 sm:gap-6 md:gap-10 lg:gap-12 xl:gap-12 my-6 sm:my-8 md:my-10 lg:my-12 xl:my-12 px-2 xs:px-4">
            {logos.map((logo, idx) => (
              <div  key={idx} className="transition-transform duration-300 hover:scale-110 flex items-center justify-center">
                <img src={logo.img}  alt={`logo${idx + 1}`}
