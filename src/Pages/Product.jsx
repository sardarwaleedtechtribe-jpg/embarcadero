    ...
    <div className="w-full xs:min-h-[40vh] sm:min-h-[30vh] md:min-h-screen lg:min-h-screen flex items-start md:items-center justify-center px-2 xs:px-3 sm:px-6 lg:px-8 ">
      ...
      <div className="w-full flex flex-col items-center justify-center ">
        <div className="w-full flex flex-col items-center text-center mt-16 xs:mt-20 sm:mt-8 md:mt-0 lg:mt-16 xl:mt-12">
          ...
          <div className="my-4 xs:my-6 sm:my-8 md:my-14 mt-4 lg:my-8 xl:my-10 w-full px-2 xs:px-4 mt-4 xs:mt-6 sm:mt-8 md:mt-6 lg:mt-6 xl:mt-8">
          ...
          <div className="flex justify-center w-full mt-2 xs:mt-4 sm:mt-6 md:mt-8 lg:mt-6 xl:mt-4 mb-6">
            <a
              href="#"
              className="flex items-center justify-center bg-gray-100 rounded-full w-10 h-10 xs:w-12 xs:h-12 sm:w-16 sm:h-16 md:w-28 md:h-28 lg:w-20 lg:h-20 xl:w-22 xl:h-22 2xl:w-40 2xl:h-40 shadow hover:bg-gray-200 transition-all transform hover:scale-110 duration-200"
            >
