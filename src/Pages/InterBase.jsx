      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center md:justify-between gap-8 md:gap-12">
        ...
        <div className="w-full md:w-1/2 md:ml-5 flex flex-col items-center md:items-start gap-4 md:gap-6 text-base sm:text-lg">
          ...
          <p className="text-gray-700 max-w-2xl text-center md:text-left">
            InterBase® is a full-featured, encryptable, scalable, embeddable,
            and multi-platform relational SQL database with commercial-grade
            data security, disaster recovery, and change synchronization.
          </p>
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 sm:gap-5 md:flex-row w-full">
            ...
            <div className="flex justify-center items-center w-full md:w-auto">
              <button className=" w-full md:w-auto px-6 py-4 h-12 text-base bg-white text-gray-800 rounded-lg transition-all duration-500 hover:bg-black hover:text-white md:text-lg flex items-center justify-center cursor-pointer">
                View Details
              </button>
            </div>
          </div>
