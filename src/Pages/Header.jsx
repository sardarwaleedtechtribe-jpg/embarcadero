...
function Header() {
  ...
  return (
    <header className="w-full bg-black text-white z-50  relative mb-2 ">
      <div className="mx-auto max-w-[1760px] w-full px-4 sm:px-6 lg:px-8  overflow-visible">
        ...
        <div className="flex h-28 sm:h-[68px] md:h-[53px] lg:h-[53px] xl:h-[53px] 2xl:h-[53px] items-center flex-col gap-4 sm:flex-row sm:justify-between sm:gap-0">
          <div className="w-full max-w-[550px] flex flex-col sm:flex-row gap-3 text-[14px] xl:ml-none 2xl:text-[16px] font-semibold tracking-tight mt-2 text-center sm:text-left">
          ...
          <div className="relative flex items-center justify-between gap-6 text-xs z-55 xl:mr-20 2xl:mr-0  ">
            ...
            {isDropdownOpen && (
              <div className="absolute top-full left-0 mt-2 bg-black border border-gray-700 rounded-md shadow-lg z-[999] w-56 sm:w-64 xl:hidden transition-all duration-200 ease-in-out">
